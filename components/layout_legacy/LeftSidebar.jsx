...
function MemoryWidget() {
  ...
  return (
    <div style={{ padding: "12px 14px 14px", borderTop: "1px solid rgba(255,255,255,.05)" }}>
      ...
      {memories.length === 0 ? (
        <div style={{ fontSize: 10, color: "rgba(255,255,255,.62)", fontStyle: "italic" }}>No memories yet. Talk to Helena.</div>
      ) : (
            ...
            <>
              ...
              <div style={{ flex: 1, overflowY: "auto", position: "relative" }}>
                <div style={{ padding: "6px 14px 2px" }}>
                  <span style={{ fontSize: 8, fontWeight: 700, color: "rgba(255,255,255,.22)", letterSpacing: ".12em" }}>PRODUCTIVITY</span>
                </div>
                <AgendaWidget />
                <CalendarWidget />

                <div style={{ padding: "6px 14px 2px", marginTop: 4 }}>
                  <span style={{ fontSize: 8, fontWeight: 700, color: "rgba(255,255,255,.22)", letterSpacing: ".12em" }}>INTELLIGENCE</span>
                </div>
                <NewsWidget />
                <MemoryWidget />

                <div style={{ padding: "6px 14px 2px", marginTop: 4 }}>
                  <span style={{ fontSize: 8, fontWeight: 700, color: "rgba(255,255,255,.22)", letterSpacing: ".12em" }}>ENVIRONMENT</span>
                </div>
                <WeatherWidget />
                <ClocksWidget />
                <MetricsWidget />
                ...
                <div style={{ padding: "6px 14px 2px", marginTop: 4 }}>
                  <span style={{ fontSize: 8, fontWeight: 700, color: "rgba(255,255,255,.22)", letterSpacing: ".12em" }}>INTEGRATIONS</span>
                </div>
                <SpotifyWidget />
                <BrainWidget />
