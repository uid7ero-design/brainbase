    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 5, alignItems: "center", flex: 1 }}>
          ...
          <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: ".12em", color: "rgba(255,255,255,.75)", textTransform: "uppercase" }}>Helena</span>
          <span style={{ fontSize: 9, letterSpacing: ".08em", color: "rgba(255,255,255,.22)", textTransform: "uppercase" }}>· Command Interface</span>
        </div>
      ...
      <div style={{ maxHeight: 360, overflowY: "auto", padding: "12px 14px", display: "flex", flexDirection: "column", gap: 12 }}>
        {messages.length === 0 && (
          <div style={{ textAlign: "center", padding: "28px 0" }}>
            ...
            <div style={{ fontSize: 11, color: "rgba(255,255,255,.28)", letterSpacing: ".06em", textTransform: "uppercase" }}>Awaiting input</div>
          </div>
        )}
        ...
        {responding && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 4 }}>
            <div style={{ fontSize: 8, fontWeight: 700, letterSpacing: ".12em", color: CYAN }}>◈ HELENA</div>
            <div style={{
