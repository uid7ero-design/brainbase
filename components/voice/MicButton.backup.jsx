    ...
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, display: "flex", flexDirection: "column", alignItems: "center", paddingBottom: 22, gap: 8, pointerEvents: "none", zIndex: 50 }}>
      ...
      <div style={{ display: "flex", gap: 8, pointerEvents: "auto", marginBottom: 2, alignItems: "center" }}>
        ...
        {llmSource && llmSource !== 'error' && (
          <span style={{ fontSize: 9, padding: "3px 7px", borderRadius: 20, background: llmSource === 'ollama' ? "rgba(134,239,172,.08)" : "rgba(0,207,234,.08)", border: `1px solid ${llmSource === 'ollama' ? "rgba(134,239,172,.20)" : "rgba(0,207,234,.20)"}`, color: llmSource === 'ollama' ? "rgba(134,239,172,.80)" : "rgba(0,207,234,.80)", letterSpacing: ".06em", fontWeight: 600, backdropFilter: "blur(8px)" }}>
