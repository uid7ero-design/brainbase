...
function RCard({ item, isNew }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 9, color: "#B8B8CC", letterSpacing: ".04em", borderTop: "1px solid rgba(0,0,0,.05)", paddingTop: 8, marginTop: 2 }}>
        Generated by HLNA — Hyper Learning Neural Agent
      </div>
    </div>
  );
}
...
export default function ResponsePanel({ responses, latestId }) {
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 13.5, fontWeight: 700, color: "#1A1A2E" }}>HLNA Outputs</div>
