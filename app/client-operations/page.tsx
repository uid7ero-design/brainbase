      ...
      >
        ...
        >
          ...
          >
            <span
              style={{
                ...
                animation: 'clientOpsPulse 2.5s ease-in-out infinite',
              }}
            />
          ...
          >
            ...
            <span
              style={{
                background: 'linear-gradient(100deg, #8A4DFF 0%, #A78BFA 50%, #5C7CFF 100%)',
          ...
          <p
            style={{
              ...
              fontSize: 15,
              lineHeight: 1.7,
              color: 'rgba(226,232,240,.61)',
            }}
          >
            BRΛINBΛSE Client Operations connects enquiries, clients, bookings,
            follow-up and operational visibility in one environment configured
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 10, flexWrap: 'wrap' }}>
            ...
            >
              Explore the Client Operations demo →
            </Link>
          ...
          >
            {CAPABILITY_PILLS.map((pill, index) => (
              <div key={pill} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                {index > 0 && (
                  <span
                    style={{
                      width: 3,
                ...
                <span style={{ fontSize: 11, fontWeight: 550, color: 'rgba(226,232,240,.50)' }}>
                  {pill}
                </span>
              </div>
            ))}
        ...
        <section style={{ marginBottom: 96 }}>
          <SectionHeading
            ...
            description="The problem usually isn't any single tool — it's the gaps between them."
            centred
          />
          ...
          >
            <div style={{ padding: '28px 30px', background: 'rgba(239,68,68,.025)' }}>
              <div
                style={{
                  marginBottom: 10,
                  fontSize: 9,
                  ...
                  letterSpacing: '.11em',
                  textTransform: 'uppercase',
                  color: 'rgba(248,113,113,.50)',
                }}
              >
                Before
              </div>

              <div style={{ fontSize: 14, lineHeight: 1.55, color: 'rgba(226,232,240,.45)' }}>
                An enquiry arrives through the website. It gets copied into a
                spreadsheet or CRM. Scheduling lives in a calendar. Follow-up
                sits in email. Reporting happens somewhere else.
              </div>
            </div>
            ...
            >
              ...
              <div style={{ fontSize: 14, lineHeight: 1.55, color: 'rgba(226,232,240,.72)' }}>
                Leads, clients, scheduling, follow-up and operational context
                stay connected in one environment.
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: 100 }}>
          <SectionHeading
            ...
            description="Each stage of the client journey stays connected to the next. The exact stages and terminology can vary by business."
            centred
          />
          ...
          >
            {JOURNEY.map((step, index) => {
              const active = hoveredJourney === index;
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 13,
                    background: active
                      ? `rgba(${hexToRgbStr(step.color)}, .055)`
                      : 'rgba(255,255,255,.018)',
                    border: active ? `1px solid ${step.color}30` : '1px solid rgba(255,255,255,.06)',
                ...
                >
                  ...
                  <div>
                    <h3 style={{ margin: '0 0 5px', fontSize: 13, fontWeight: 650, color: '#F5F7FA' }}>
                      {step.title}
                    </h3>

                    <p style={{ margin: 0, fontSize: 11, lineHeight: 1.6, color: 'rgba(226,232,240,.53)' }}>
                      {step.body}
                    </p>
                  </div>
                </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    overflow: 'hidden',
                    background: active
                      ? `rgba(${hexToRgbStr(outcome.color)}, .05)`
                      : 'rgba(255,255,255,.018)',
                    border: active ? `1px solid ${outcome.color}30` : '1px solid rgba(255,255,255,.06)',
                    transform: active ? 'translateY(-2px)' : 'translateY(0)',
                    transition: 'all .17s',
                  }}
                >
                  <div
                    style={{
                      ...
                      boxShadow: `0 0 8px ${outcome.color}80`,
                      marginBottom: 17,
                    }}
                  />

                  <h3 style={{ margin: '0 0 7px', fontSize: 14, fontWeight: 650, color: '#F5F7FA' }}>
                    {outcome.title}
                  </h3>

                  <p style={{ margin: 0, fontSize: 11, lineHeight: 1.62, color: 'rgba(226,232,240,.55)' }}>
                    {outcome.description}
                  </p>
                </div>
              );
        ...
        {/* ================================================================
            4. BUILT AROUND HOW YOU OPERATE
        ================================================================= */}
        ...
        <section style={{ marginBottom: 100 }}>
          <SectionHeading
            ...
            description="Terminology, stages, booking or service structure, follow-up requirements and the information you collect can all differ by business."
            centred
          />
          ...
          >
            Same BRΛINBΛSE capabilities. Configured around your operation.
          </p>
        </section>
        ...
        <section style={{ marginBottom: 100 }}>
          <SectionHeading
            ...
            description="Many client-based businesses begin with just a few capabilities."
            centred
          />
          ...
          >
            Add more BRΛINBΛSE capabilities as your operation grows. This is
            one way into the wider BRΛINBΛSE platform.
          </p>
        </section>

        {/* ================================================================
            6. CORE CLIENT OPERATIONS CAPABILITIES
        ================================================================= */}
        ...
        <section
          ...
          style={{
            ...
            padding: 42,
            borderRadius: 18,
            background: 'linear-gradient(135deg, rgba(138,77,255,.06), rgba(56,189,248,.015))',
        ...
        >
          <div style={{ marginBottom: 30 }}>
            ...
            <p style={{ margin: 0, maxWidth: 650, fontSize: 13, lineHeight: 1.65, color: 'rgba(226,232,240,.53)' }}>
              Each capability can be configured around how your business
              actually operates.
            </p>
          </div>
                ...
                <div
                  ...
                  style={{
                    ...
                    background: active
                      ...
                      : 'rgba(7,8,11,.26)',
                    border: active ? `1px solid ${capability.color}30` : '1px solid rgba(255,255,255,.06)',
                    transition: 'all .16s',
                  }}
                >
                  <div
                  ...
                  >
                    <span
                      style={{
                        ...
                        boxShadow: `0 0 7px ${capability.color}80`,
                      }}
                    />

                    <span style={{ fontSize: 13, fontWeight: 650, color: '#F5F7FA' }}>
                      {capability.title}
                    </span>
                  </div>

                  <p style={{ margin: 0, fontSize: 10, lineHeight: 1.55, color: 'rgba(226,232,240,.47)' }}>
          ...
          >
            ...
            <span style={{ fontSize: 10, fontWeight: 700, color: '#F5F7FA' }}>
        ...
        <section style={{ marginBottom: 100 }}>
          <SectionHeading
            ...
            description="BRΛINBΛSE doesn't need to replace every specialist system your business relies on. External systems can connect where it helps keep the operation in one place."
            centred
          />
        ...
        <section style={{ marginBottom: 100 }}>
          <SectionHeading
            ...
            description="Instead of piecing together enquiries, clients, bookings and follow-up across separate tools, the business gets a clearer picture in one place."
            centred
          />
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(167,139,250,.85)', letterSpacing: '.10em' }}>
                  HLNΛ
                </span>
                ...
                {['Leads', 'Clients', 'Scheduling', 'Requests', 'Reporting'].map(item => (
                  <span
                    ...
                    style={{
                      fontSize: 10,
                      color: item === 'Scheduling' ? '#C4B5FD' : 'rgba(255,255,255,.34)',
                      padding: '5px 7px',
                      borderRadius: 6,
                      background: item === 'Scheduling' ? 'rgba(138,77,255,.09)' : 'transparent',
                    }}
                  >
                    {item}
                  </span>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                ...
                <span style={{ fontSize: 9, color: 'rgba(255,255,255,.30)' }}>EXAMPLE VIEW</span>
              </div>
            </div>

            <div className="client-ops-live-body" style={{ padding: 30 }}>
              <div style={{ marginBottom: 22 }}>
                ...
                <h3 style={{ margin: '0 0 4px', fontSize: 23, fontWeight: 650, letterSpacing: '-.025em', color: '#F5F7FA' }}>
                  Operational Dashboard
                </h3>

                <p style={{ margin: 0, fontSize: 11, color: 'rgba(226,232,240,.40)' }}>
                  Leads, clients, sessions and follow-up activity — shown
                  with example data.
                </p>
              </div>
              ...
              >
                {[
                  { label: "Today's Sessions", value: '6', sub: 'Scheduled today', color: '#8A4DFF' },
                  { label: 'New Leads', value: '6', sub: 'Last 7 days', color: '#22C55E' },
                  { label: 'Follow-ups', value: '5', sub: 'Awaiting response', color: '#F59E0B' },
                  { label: 'Open Leads', value: '7', sub: 'New or contacted', color: '#3B82F6' },
                ].map(card => (
                  <div
                    key={card.label}
                    style={{
                  ...
                  >
                    ...
                    <div style={{ fontSize: 28, lineHeight: 1, fontWeight: 700, color: card.color, marginBottom: 6 }}>
                      {card.value}
                    </div>

                    <div style={{ fontSize: 9, color: 'rgba(255,255,255,.28)' }}>{card.sub}</div>
                  </div>
                ))}
              </div>
              ...
              >
                ...
                >
                  <PanelHeader title="Today's Schedule" action="View Schedule →" />

                  <div style={{ padding: 14 }}>
                    {[
                      { name: 'Client Session', time: '09:00–10:00', location: 'Location A', color: '#8A4DFF' },
                      { name: 'Group Program', time: '14:30–15:30', location: 'Location B', color: '#22C55E' },
                      { name: 'Private Appointment', time: '17:00–18:00', location: 'Location A', color: '#F59E0B' },
                    ].map(session => (
                      <div
                        key={session.name}
                        style={{
                      ...
                      >
                        <div style={{ fontSize: 10, fontWeight: 650, color: '#F5F7FA', marginBottom: 3 }}>
                          {session.name}
                        </div>

                        <div style={{ fontSize: 9, color: 'rgba(255,255,255,.34)' }}>
                ...
                >
                  <PanelHeader title="Needs Attention" action="All Clients →" />
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        padding: '14px 15px',
                        borderBottom: index < 2 ? '1px solid rgba(255,255,255,.045)' : 'none',
                        display: 'flex',
                        justifyContent: 'space-between',
                        alignItems: 'center',
                        gap: 10,
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontSize: 9, color: 'rgba(255,255,255,.30)' }}>{client.status}</div>
                      </div>
        ...
        >
          ...
          >
            HLN<span style={{ color: '#8A4DFF' }}>Λ</span> — intelligence
          ...
          >
            When client, booking, workflow and activity information is
            connected, HLNΛ can help surface what needs attention, what has
            changed and where there are gaps.
          </p>
          ...
          >
            See HLNΛ in the Client Operations demo →
          </Link>
        </section>
            ...
            >
              <div>
                ...
                <p style={{ margin: 0, maxWidth: 560, fontSize: 13, lineHeight: 1.7, color: 'rgba(226,232,240,.56)' }}>
                  ...
                  Tennis operates. LD Tennis connects website enquiries,
                  leads, clients, coaching sessions, follow-up and
                  operational reporting through the same BRΛINBΛSE platform.
                </p>
        ...
        {/* ================================================================
            11. RELATIONSHIP TO THE WIDER PLATFORM
        ================================================================= */}
        ...
        <section style={{ marginBottom: 100, textAlign: 'center' }}>
          ...
          >
            Client Operations is a starting configuration of BRΛINBΛSE — not
            the limit of the platform. Additional capabilities can be
            introduced as your operation grows.
          </p>
        </section>
        ...
        <section style={{ marginBottom: 100 }}>
            ...
            {PRICING.map(plan => (
              <div
                ...
                style={{
                  ...
                  boxShadow: plan.popular ? '0 20px 60px rgba(34,197,94,.055)' : 'none',
                }}
              >
                {plan.popular && (
                  <span
                ...
                <div style={{ marginBottom: 7, fontSize: 12, fontWeight: 650, color: plan.color }}>
                  {plan.name}
                </div>
                ...
                <div
                  style={{
                    minHeight: 48,
                    paddingRight: plan.popular || plan.enterprise ? 68 : 0,
                    marginBottom: 18,
                    fontSize: 15,
                    lineHeight: 1.3,
                    fontWeight: 650,
                ...
                <div style={{ minHeight: 48, display: 'flex', alignItems: 'flex-start', gap: 4, marginBottom: 5 }}>
                  {plan.price !== null ? (
                    <>
                      <span style={{ fontSize: 38, lineHeight: 1, fontWeight: 700, letterSpacing: '-.04em', color: '#F5F7FA' }}>
                        ${plan.price}
                      </span>

                      <span style={{ paddingTop: 23, fontSize: 11, lineHeight: 1, color: 'rgba(255,255,255,.30)' }}>
                        / month
                      </span>
                    </>
                  ) : (
                ...
                <div style={{ marginBottom: 22, fontSize: 9, color: 'rgba(255,255,255,.25)' }}>
                  {plan.enterprise ? 'Scoped to your organisation' : 'Platform subscription'}
                </div>

                <div style={{ height: 1, background: 'rgba(255,255,255,.055)', marginBottom: 20 }} />
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 26, flex: 1 }}>
                  {plan.features.map(feature => (
                    <div key={feature} style={{ display: 'flex', alignItems: 'flex-start', gap: 9 }}>
                      <span style={{ color: plan.color, fontSize: 10, lineHeight: 1.5 }}>✓</span>

                      <span style={{ fontSize: 11, lineHeight: 1.5, color: 'rgba(226,232,240,.58)' }}>
                        {feature}
                      </span>
                    </div>
                  ))}
                ...
                <Link
                  ...
                  style={{
                    ...
                    justifyContent: 'center',
                    borderRadius: 8,
                    background: plan.popular ? 'rgba(34,197,94,.13)' : `${plan.color}10`,
                    border: plan.popular ? '1px solid rgba(34,197,94,.30)' : `1px solid ${plan.color}30`,
                    color: plan.popular ? '#86EFAC' : plan.color,
                    textDecoration: 'none',
                    fontSize: 11,
                    fontWeight: 650,
                  }}
          ...
          >
            <div style={{ marginBottom: 6, fontSize: 10, fontWeight: 650, color: 'rgba(245,247,250,.58)' }}>
              Platform subscription + implementation where required.
            </div>

            <p style={{ margin: '0 auto 12px', maxWidth: 720, fontSize: 10, lineHeight: 1.65, color: 'rgba(226,232,240,.38)' }}>
              Monthly pricing covers the BRΛINBΛSE platform subscription.
              Initial configuration, data migration, website work and custom
              integrations may involve separate implementation costs
              depending on your requirements. Any additional costs are
              scoped and quoted before work begins.
            </p>

            <Link href="/pricing" style={{ fontSize: 10, fontWeight: 650, color: '#A78BFA', textDecoration: 'none' }}>
        ...
        <section
          ...
          style={{
            ...
            position: 'relative',
            overflow: 'hidden',
            background: 'linear-gradient(135deg, rgba(138,77,255,.075), rgba(56,189,248,.025))',
            border: '1px solid rgba(138,77,255,.16)',
          }}
        >
          <div style={{ maxWidth: 670, margin: '0 auto', position: 'relative' }}>
            <div
              style={{
                marginBottom: 11,
                fontSize: 9,
            ...
            >
              Whether you run coaching sessions, consultations, appointments,
              programs or another client-based service, BRΛINBΛSE can
              provide the operational system behind the work.
            </p>
...
function SectionHeading({
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: 0, fontSize: 13, lineHeight: 1.7, color: 'rgba(226,232,240,.57)' }}>
        {description}
      </p>
    </div>
  );
...
function PanelHeader({ title, action }: { title: string; action: string }) {
  return (
    ...
    >
      ...
      <span style={{ fontSize: 9, color: '#8A4DFF' }}>{action}</span>
    </div>
  );
}
