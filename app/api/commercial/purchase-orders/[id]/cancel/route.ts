...
export async function POST(req: NextRequest, { params }: Ctx) {
  ...
  try {
    ...
    if (message.includes('concurrently') || message.includes('Cannot transition purchase order') || message.includes('posted purchase receipts') || message.includes('posted supplier bills')) {
