...
// Phase C3 — identical to app/crm/_components/SlidePanel.tsx. Not
// imported from there directly: app/crm's _components directory is not
// a shared cross-module import path in this codebase (every existing
// product shell — CRM, Organiser — keeps its own _components folder),
// so this is a deliberate, exact copy of an already-proven pattern
