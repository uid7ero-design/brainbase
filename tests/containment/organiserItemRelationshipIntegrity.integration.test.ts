...
describe.skipIf(!shouldRun)('Organiser item relationship validation — real database integration', () => {
  ...
  beforeAll(async () => {
    ...
    await sql.transaction([
      ...
      sql.query(`INSERT INTO ${T('organiser_items')} (id, board_id, organisation_id, group_id, name) VALUES
        ('33333333-3333-3333-3333-333333331a10', '11111111-1111-1111-1111-111111111a1a', 'org-a', '22222222-2222-2222-2222-222222221a1a', 'iA1_root'),
        ('33333333-3333-3333-3333-333333331a11', '11111111-1111-1111-1111-111111111a1a', 'org-a', '22222222-2222-2222-2222-222222221a1a', 'iA1_other'),
    ...
    await sql.query(
      `INSERT INTO ${T('organiser_items')} (id, board_id, organisation_id, group_id, parent_item_id, name) VALUES
        ('33333333-3333-3333-3333-333333331a12', '11111111-1111-1111-1111-111111111a1a', 'org-a', '22222222-2222-2222-2222-222222221a1a', '33333333-3333-3333-3333-333333331a10', 'iA1_mid'),
        ('33333333-3333-3333-3333-333333331a13', '11111111-1111-1111-1111-111111111a1a', 'org-a', '22222222-2222-2222-2222-222222221a1a', '33333333-3333-3333-3333-333333331a12', 'iA1_leaf')`,
    )
  })
  ...
  const A1_ROOT = '33333333-3333-3333-3333-333333331a10'
  const A1_MID = '33333333-3333-3333-3333-333333331a12'
  const A1_LEAF = '33333333-3333-3333-3333-333333331a13'
  const A1_OTHER = '33333333-3333-3333-3333-333333331a11'
